## 0.8.6.1 2019-08-09
- When using SCP options, transfer module output to SFTP server when --zm true is used. This pushes the output from modules as a zip file to the SFTP server. You can still optionally SFTP target collection too
