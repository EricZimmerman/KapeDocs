...
To see a list of missing module executables, use --mlist . --mdetail (be sure to do this for each folder you are interested in). Any missing binaries will be displayed, like this:
