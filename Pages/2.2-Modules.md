...
![Module example](https://github.com/EricZimmerman/KapeDocs/blob/master/ModuleExample.jpg)
...
![fileName var](https://github.com/EricZimmerman/KapeDocs/blob/master/fileNameVar.jpg)
...
![ExportFile example](https://github.com/EricZimmerman/KapeDocs/blob/master/ExportFileExample.jpg)
...
file if more than one SYSTEM hive exists. This would then result in multiple ExportFile creation such as device.txt, device1.txt, device2.txt, and so on.

**With this said, do NOT try to use redirection on the command line. It will NOT work!** i.e. do not do this:
...
![Compound module example](https://github.com/EricZimmerman/KapeDocs/blob/master/CompoundModuleExample.jpg)
